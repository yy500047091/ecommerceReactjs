...
function LoginHeader(){
    ...
    <><nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <a className="navbar-brand" href="#"> <img src="./logo.jpeg" className="rounded float-start" width="70" height="50" alt="SYGMA"></img></a>
                ...
                <div className="d-flex justify-content-end">
                  <Link to="/login" className='text-white' style={{textDecoration:"none"}}> Welcome {sessionStorage.getItem("username")}</Link>  
                   {/* <Link to="/logout" className='text-white' style={{textDecoration:"none"}}> Logout</Link>  */}
                   <button onClick={Logout}>Logout</button>
                    <a className="navbar-brand" href="#"><Link to="/cart" className='text-white' style={{textDecoration:"none"}}><i className="bi bi-cart3"> Cart</i></Link> </a>
                </div>
                </div>
                </nav>
